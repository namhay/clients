    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="card p-4">
          <h2 className="text-sm font-medium text-gray-900 mb-4">Services by Type</h2>
          {Object.entries(byType).map(([type, count]:any) => (
            <div key={type} className="flex items-center gap-3 mb-3">
              <div className="text-xs text-gray-500 w-20">{type}</div>
        ...
        <div className="card p-4">
          <h2 className="text-sm font-medium text-gray-900 mb-4">Invoice Status</h2>
