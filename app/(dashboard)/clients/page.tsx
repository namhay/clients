      ...
      <div className="card">
        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50"><tr>
            ...
            <th className="text-left px-4 py-2.5 text-xs text-gray-500 font-medium">Phone</th>
            <th className="text-left px-4 py-2.5 text-xs text-gray-500 font-medium">Services</th>
            <th className="text-left px-4 py-2.5 text-xs text-gray-500 font-medium">Invoices</th>
            <th className="text-left px-4 py-2.5 text-xs text-gray-500 font-medium">Joined</th>
            <th className="px-4 py-2.5"></th>
          </tr></thead>
          <tbody>
            {loading && <tr><td colSpan={7} className="px-4 py-8 text-center text-gray-400">Loading...</td></tr>}
            {!loading && clients.length === 0 && <tr><td colSpan={7} className="px-4 py-8 text-center text-gray-400">No clients found</td></tr>}
            {clients.map(c => (
